...
<body class="hold-transition sidebar-mini sidebar-collapse">
                ...
                <div class="modal-body">
                  ...
                  <div class="form-group">
                    <div class="row">
                      ...
                      <div class="col-md-4">
                        <label for="discount_item">Jumlah Diskon</label>
                        <input type="number" id="jml_discount_item" class="form-control">
                      </div>
                    </div>
                  </div>
                  <div class="form-group">
  ...
  <script>
    ...
    function calculate() {
      ...
      // diskon untuk rupiah
      //var discount_rupiah = $('#discount').val()
      //var grand_total = subtotal - discount_rupiah

      // diskon untuk persen
      var discount = $('#discount').val()
      var nilai_diskon_persen = (discount / 100) * subtotal
      var grand_total = subtotal - nilai_diskon_persen

      //if(dicount_rupiah != 0 & discount_persen == 0) {
//}
    ...
    function count_edit_modal() {
      ...
      harga_barang = total_before
      if (discount_rp != 0 & discount_persen == 0) {
        total = harga_barang- (jml_discount_item * discount_rp)
      } else if (discount_persen != 0 & discount_rp == 0) {
        nilai_diskon_persen = (discount_persen / 100) * price
        disc = nilai_diskon_persen * jml_discount_item
	total = total_before - disc
      } else if (discount_persen != 0 & discount_rp != 0) {
