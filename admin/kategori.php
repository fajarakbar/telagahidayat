                          ...
                          <td style="width:15%">
                            <div class="dropdown">
                              ...
                              <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                <a class="dropdown-item" href="ubahkategori.php?id=<?php echo $kategori['category_id']; ?>">Ubah</a>
                                <a class="dropdown-item" href="hapuskategori.php?id=<?php echo $kategori['category_id']; ?>">Hapus</a>
                              </div>
                            </div>
                          </td>
                        </tr>
