            ...
            <div class="col-12">
              <div class="card">
                <div class="card-header">
                  <table>
                    <td>
                      <a href="tambahstokmasuk.php"><button type="button"
                          class="btn btn-block btn-primary btn-sm">Tambah Stok Masuk</button></a>
                    </td>
                    <td>
                ...
                <div class="card-body table-responsive p-0">
                  <table class="table table-hover text-nowrap">
                    ...
                    <tbody>
                      <?php
                  include '../koneksi.php';
                  $query = "SELECT idstokmasuk,outlet,tanggal, COUNT(idstokmasuk) FROM tb_inventori GROUP BY idstokmasuk";
