          ...
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item has-treeview menu-open">
              ...
              <ul class="nav nav-treeview">
                ...
                <li class="nav-item">
                  <a href="labaharian.php" class="nav-link active">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Laba Harian</p>
                  </a>
                </li>
            ...
            <div class="col-12">
              <div class="card">
                <div class="card-header">
                  <h3 style="padding-top:6px" class="card-title">Laba Harian</h3>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
          ...
          $('#records').DataTable({
            "footerCallback": function(row, data, start, end, display) {
              ...
              $(api.column(2).footer()).html(
                '<b>' + pagepenjualan + ' (' + penjualan + ')</b>'
              );
              $(api.column(3).footer()).html(
                '<b>Rp. ' + pagediskon + ' ( Rp. ' + diskon + ')</b>'
              );
              $(api.column(4).footer()).html(
                '<b>Rp. ' + pagepembelian + ' ( Rp. ' + pembelian + ')</b>'
              );
              $(api.column(5).footer()).html(
                '<b>Rp. ' + pageprofitharian + ' ( Rp. ' + profitharian + ')</b>'
              );
            },
            "data": data,
            // buttons
            ...
            "columns": [{
              ...
              },
              {
                "data": "profitharian",
                "render": function(data, type, row, meta) {
                  return parseInt(row.profitharian);
                }
              }
            ]
          });
