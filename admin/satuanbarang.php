          ...
          <div class="row">
            <div class="col-12">
              <div class="card">
                ...
                <?php
                $no = 1;
                $query = "SELECT * FROM p_satuanbarang ORDER BY name ASC";
                          ...
                          <td style="width:15%">
                            <div class="dropdown">
                              ...
                              <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                <a class="dropdown-item" href="ubahsatuanbarang.php?id=<?php echo $satuanbarang['unit_id']; ?>">Ubah</a>
                                <a class="dropdown-item" href="hapussatuanbarang.php?id=<?php echo $satuanbarang['unit_id']; ?>">Hapus</a>
                              </div>
                            </div>
                          </td>
                        </tr>
