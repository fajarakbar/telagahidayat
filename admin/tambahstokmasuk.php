  ...
  <div class="wrapper">
    ...
    <nav class="main-header navbar navbar-expand navbar-white navbar-light">
      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item d-none d-sm-inline-block">
          <a href="stokmasuk.php" class="nav-link">Stok Masuk</a>
        </li>
      </ul>
    </nav>
    <!-- /.navbar -->
          ...
          <div class="row">
            <div class="col-12">
              ...
              <div class="card">
                ...
                <?php
              include '../koneksi.php';
              $query = mysqli_query($koneksi, "SELECT MAX(idstokmasuk) AS idterbesar FROM tb_inventori");
              $data = mysqli_fetch_assoc($query);
              $idstokmasuk = $data['idterbesar'];
              $urutan = (int) substr($idstokmasuk, 3, 7);
              $urutan++;
              $huruf = "SM-";
              $idstokmasuk = $huruf . sprintf("%07s", $urutan);
              ?>
                <!-- form start -->
                <form action="prosesstokmasuk.php" method="post">
                  <div class="card-body">
                    <input type="text" name="idstokmasuk" class="form-control" id="#" required
                      value="<?php echo $idstokmasuk; ?>" readonly>
                    <div class="form-group">
                      <label for="outlet">Outlet</label>
                      <select name="outlet" class="form-control select2" style="width: 100%;" required>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="tanggal" class="form-control" id="#" required>
                    </div>
                    ...
                    <table id="table_field" class="table">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>
                            <input type="text" name="hargabeliperunit[]" class="form-control" id="#">
                          </td>
                          <td>
                            <input type="text" name="totalhargabeli[]" class="form-control" id="#">
                          </td>
                          <td>
                            <input class="btn btn-warning" type="button" name="addd" id="add" value="Tambah">
                          </td>
                        </tr>
                      </tbody>
                    </table>
                  ...
                  <div class="card-footer">
                    <a href="stokmasuk.php" name="batal" class="btn btn-secondary">Batal</a>
