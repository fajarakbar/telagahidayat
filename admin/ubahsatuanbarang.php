            ...
            <div class="col-md-6">
              ...
              <div class="card">
                <div class="card-header">
                  <h3 class="card-title">Ubah Satuan Barang</h3>
                </div>
                <!-- /.card-header -->
                <?php
                $id = $_GET['id'];
                ...
                $query = "SELECT * FROM p_satuanbarang WHERE unit_id = '$id'";
                  ...
                  <form action="prosessatuanbarang.php" method="post">
                    <div class="card-body">
                      <div class="form-group">
                        ...
                        <input type="hidden" name="id" class="form-control" id="#" value="<?php echo $satuanbarang['unit_id']; ?>">
                        <input type="text" name="namasatuanbarang" class="form-control" id="#" value="<?php echo $satuanbarang['name']; ?>" required>
                      </div>
                    </div>
                    <!-- /.card-body -->
                    ...
                    <div class=" card-footer">
                      ...
                      <button type="submit" name="ubahsatuanbarang" class="btn btn-primary">Simpan</button>
                    </div>
                  </form>
                <?php } ?>
              </div>
